    ...
    >
      <div className="flex items-center justify-between">
        ...
        <ul className="hidden md:flex gap-8 text-white font-medium">
          <li>
            <a href="#home" className="hover:text-[#C7A35A]">
              Home
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="#skills" className="hover:text-[#C7A35A]">
              Skills
            </a>
          </li>
          <li>
        ...
        <a
          ...
          className="hidden md:block border border-[#C89B5A] text-[#C89B5A] font-bold px-5 py-2 rounded-full text-sm
