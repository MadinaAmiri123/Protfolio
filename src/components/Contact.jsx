...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="relative bg-gradient-to-b from-[#0A0A0A] to-[#1A1A1A] py-32 px-[6%] md:px-[10%]"
    >
      {/* Heading */}
      <motion.div
        initial={{ y: 30, opacity: 0 }}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        >
          ...
          {/* EMAIL LINK */}
          <a
            href="mailto:madinaamiri2@gmail.com"
            className="relative z-50 pointer-events-auto text-white font-medium hover:underline cursor-pointer"
          >
            madinaamiri2@gmail.com
          </a>

          <div className="h-[1px] bg-gray-300/30 mt-6 mb-10 w-64" />

          {/* SOCIAL LINKS */}
          <div className="relative z-50 flex gap-6 text-xl pointer-events-auto">
            {/* GITHUB */}
            <a
              href="https://github.com/MadinaAmiri123"
              target="_blank"
              rel="noopener noreferrer"
              className="relative z-50 pointer-events-auto w-12 h-12 bg-white/20 text-[#C7A35A] rounded-full flex items-center justify-center hover:scale-110 transition-shadow shadow-lg cursor-pointer"
              aria-label="GitHub"
            >
              <FaGithub />
            </a>
